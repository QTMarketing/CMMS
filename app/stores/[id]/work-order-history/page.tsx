...
export default async function StoreWorkOrderHistoryPage({ params }: PageProps) {
  ...
  return (
    <StorePageShell store={store} title="Work Order History">
      <div className="p-6 text-gray-500 border-t border-gray-100">
        Work order history table placeholder — content will be filled later.
      </div>
    </StorePageShell>
  );
}
