...
export default async function StoreAssetsPage({ params }: PageProps) {
  ...
  return (
    <StorePageShell store={store} title="Assets">
      <div className="p-6 text-gray-500 border-t border-gray-100">
        Assets table placeholder — content will be filled later.
      </div>
    </StorePageShell>
  );
}
