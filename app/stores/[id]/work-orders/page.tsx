...
export default async function StoreWorkOrdersPage({ params }: PageProps) {
  ...
  return (
    <StorePageShell store={store} title="Work Orders">
      <div className="p-6 text-gray-500 border-t border-gray-100">
        Work orders table placeholder — content will be filled later.
      </div>
    </StorePageShell>
  );
}
