...
export default async function StorePreventiveMaintenancePage({ params }: PageProps) {
  ...
  return (
    <StorePageShell store={store} title="Preventive Maintenance">
      <div className="p-6 text-gray-500 border-t border-gray-100">
        Preventive maintenance table placeholder — content will be filled later.
      </div>
    </StorePageShell>
  );
}
